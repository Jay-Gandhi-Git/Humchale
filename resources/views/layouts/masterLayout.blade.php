...
<div class="copyright py-3">
    <div class="container">
        ...
        <div class="copyrightbottom">
            <p>© 2018 Vagabond. All Rights Reserved | Design by
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Registtration</h4>
            ...
            <div class="modal-body">
                ...
                {{--<h2 class="heading-agileinfo text-center pb-4">Registration<span> Us</span></h2>--}}
                {{--<h2 class="heading-agileinfo text-center pb-4">Registration</h2>--}}
                {{--</div>--}}
                ...
                <div class="contact_grid_right mt-5">
                    ...
                    <form action="#" method="post" autocomplete="off">
                        <div class="contact_left_grid">
                            ...
                            <input type="text" name="Adharcard" placeholder="Adharcard Number" required="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="radio" name="gender" value="Male" id="radio-one" class="form-radio" checked><label for="radio-one">Male</label>
                                </div>
                                <div class="col-md-6">
                                    <input type="radio" name="gender" value="Fe-Male" id="radio-one" class="form-radio" ><label for="radio-one">Fe-Male</label>
                                </div>
                            </div>


                            <textarea name="Message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Address...';}" required="">Address...</textarea>
