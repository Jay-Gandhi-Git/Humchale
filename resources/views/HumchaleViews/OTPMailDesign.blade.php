...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //for-mobile-apps -->
    <link href="css/OTP/style.css" rel="stylesheet" type="text/css" media="all" />
    ...
    <style type="text/css">
        ...
        html, body{
            font-size: 100%;
            background: url(../../images/OTP/banner.jpg) no-repeat 0px 0px;
        ...
        .wthree_social_icons a:nth-of-type(2):before {
            content:'';
            background:url(../../images/OTP/img-sp.png) no-repeat -18px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(3):before {
            content:'';
            background:url(../../images/OTP/img-sp.png) no-repeat -53px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(4):before {
            content:'';
            background:url(../../images/OTP/img-sp.png) no-repeat -89px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(5):before {
            /*-- w3layouts --*/
            content:'';
            background:url(../../images/OTP/img-sp.png) no-repeat -122px 11px;
            display:block;
            width:40px;
            height:40px;
        }
...
<div class="main">
    ...
    <h1>{{$otp}}</h1>
    <h2 style="background: #9fcdff">Thank You for registerd</h2>
    <div class="more_w3ls">
        <a href="http://localhost:8000/">Humchale</a>
    </div>
    <div class="copyright">
        <p>© 2019 All rights reserved | Design by <a href="#">Krunal Sukhwani</a></p>
    </div>
</div>
</body>
</html>